...
export default function Mutation(melody, debug) {
	...
	const durations = new PropRange([2, 4], [1, 8]); 
	...
	this.getLoops = function() {
		...
		// return loops;
		// if noteDuration is less than 4, coutner really could be anything less than 1
		return [
		// {
		// 	noteDuration: 4,
		// 	counter: 1, // duration < 4 ? duration / 4 : 1,
		// 	count: 0,
		// 	doubler: false, // whether to double hits that dont fill duration
		// 	doublerCounter: false, // increment count for doubles
		// 	repeat: 1,
		// 	startIndex: 0,
		// 	startDelay: 0,
		// 	melody: melody,
		...
		// },
		{
			...
			counter: 1,
			count: 0,
			doubler: true, // whether to double hits that dont fill duration
			doublerCounter: true, // increment count for doubles
			repeat: 2, // doubler counter
			startIndex: 0,
			startDelay: 0,
			melody: melody,
			harmony: 6,
